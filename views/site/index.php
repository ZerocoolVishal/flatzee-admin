        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav align-items-center d-none d-md-flex">
                ...
                <span class="avatar avatar-sm rounded-circle">
                  <?= Html::img('@web/img/theme/team-4-800x800.jpg') ?>
                </span>
                            <div class="media-body ml-2 d-none d-lg-block">
                                <span class="mb-0 text-sm  font-weight-bold"><?= (Yii::$app->user->isGuest) ? "" : Yii::$app->user->identity->first_name . " " . Yii::$app->user->identity->last_name ?></span>
                            </div>
                        </div>
                    </a>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <span class="h2 font-weight-bold mb-0"><?= $totalProperties ?></span>
                                    </div>
                                    <div class="col-auto">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <span class="h2 font-weight-bold mb-0"><?= $appointmentsCount ?></span>
                                    </div>
                                    <div class="col-auto">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <span class="h2 font-weight-bold mb-0"><?= $conversion ?>%</span>
                                    </div>
                                    <div class="col-auto">
